...
if __name__ == "__main__":
    ...
    with open("." + split[1] + ".rs", "w") as f:
        ...
        f.write(
            "pub unsafe fn hash_kernel_vcrypto(kernel_size: u64, kernel_pointer: u64, result: &mut [u64]) -> u32 {\n"
        )
        f.write("\t#[allow(unused_assignments)]\n")
        f.write("\tlet mut counter: u32 = 0;\n")
        f.write("\tasm!(\n")
        ...
        f.write("\t\tcounter = out(reg) counter\n")
        f.write("\t);\n")
